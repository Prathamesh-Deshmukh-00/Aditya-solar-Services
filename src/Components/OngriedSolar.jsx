  ...
  const faqs = [
    {
      ...
      answer:
        "No. That's the beauty of installing an on-grid solar system. It does not require a battery connection like off-grid and hybrid solar systems, which makes it easier to maintain and the most affordable option of the three types.",
    },
    {
      question: "Do solar panels work at night?",
      answer:
        "No. Solar panels generate electricity when photons from sunlight knock electrons loose in the PV cells. At night, an on-grid solar system draws power from the grid to keep a house running.",
    },
    {
      question:
        "What is the difference between on-grid and hybrid solar systems?",
      answer:
        "The main difference is that a hybrid system is connected to the grid and batteries, while an on-grid solar system is connected only to the grid.",
    },
    {
      question: "What is the on-grid solar panel price in India?",
      answer:
        "The prices vary based on the type of solar panels. For instance, the latest technology, MonoPERC half-cut solar panels in India, cost Rs. 24 per watt.",
    },
  ];
      ...
      <main className="max-w-6xl mx-auto px-3 py-6 sm:px-4 sm:py-12">
        ...
        <section className="bg-white rounded-lg shadow-lg p-4 mb-6 sm:p-8 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4 leading-relaxed">
            An on-grid solar system, also known as a grid-tied system, is
            directly connected to the main electricity grid. In Maharashtra,
            homeowners installing a rooftop on-grid solar system can avail
            government subsidies under the PM-Surya Ghar Muft Bijli Yojana.
            Subsidy amounts generally range between Rs. 30,000 and Rs. 78,000
            depending on the system capacity and eligibility criteria.
          </p>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-3 mb-3 sm:p-4 sm:mb-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 text-xs sm:text-base">
              <li>
                3 kW on-grid solar system price in Maharashtra with subsidy: ~
                Rs. 1,12,000 – Rs. 1,20,000
              </li>
              <li>
                5 kW on-grid solar system price in Maharashtra with subsidy: ~
                Rs. 2,07,000 – Rs. 2,20,000
              </li>
            </ul>
          </div>

          <p className="text-xs sm:text-sm text-gray-600 italic">
            *Please note: These prices are approximate for Maharashtra as of
            16th November 2025. Final cost may vary based on city, DISCOM
            requirements (MSEDCL, BEST, TATA Power), panel type, installation
            site, and other applicable charges.
          </p>
        </section>
        ...
        <section className="mb-6 sm:mb-8 md:mb-16">
          ...
          <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 md:p-8 border-l-4 border-blue-600">
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed mb-3 md:mb-4">
              An on-grid solar system (grid-tied) connects directly to the
              utility grid through a bi-directional meter (net meter). Most
              Indian homes with a reliable grid connection choose on-grid solar
              since this system is powerful enough to support all household
              energy requirements.
            </p>
            <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
              The on-grid solar system is a careful compilation of many
              components, listed below, arranged together to convert sunlight
              into electricity:
            </p>
            <ul className="mt-3 md:mt-4 space-y-1.5 sm:space-y-2 text-xs sm:text-sm md:text-base text-gray-700">
              ...
              <li className="flex items-start">
                <span className="text-blue-600 mr-2">•</span>
                <span>
                  Solar accessories (AC and DC cables, AC and DC combiner boxes,
                  conduit trays, lightning arrester, MC4 connectors)
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-gradient-to-r from-amber-100 to-yellow-100 rounded-xl shadow-md p-4 mb-6 sm:p-6 sm:mb-8 md:mb-16 border-l-4 border-amber-500">
          ...
          <p className="text-xs sm:text-sm md:text-base text-gray-700 leading-relaxed">
            When maintained properly, an on-grid solar system can last for 25
            years. Contrary to popular belief, cleaning your panels with
            sprinklers can actually damage them. To keep your system operating
            at its peak efficiency, be sure to sign up for professional
        ...
        <section className="mb-6 sm:mb-8 md:mb-16">
          ...
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            {components.map((component, index) => (
              <div
                key={index}
                className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 hover:shadow-xl transition-shadow"
              >
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-base sm:text-lg md:text-2xl font-bold text-gray-800 mb-2 md:mb-4">
                      {index + 1}. {component.title}
                    </h3>
                    <p className="text-xs sm:text-sm md:text-base text-gray-700 leading-relaxed mb-3 md:mb-4">
                    ...
                    {component.features && (
                      <div className="mt-3 md:mt-4">
                        <p className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-2">
                          The best solar module mounting structures are
                          prefabricated in precision labs. They're coated with
                          hot-dip galvanizing on steel to make them rust-proof.
                        </p>
                        <p className="text-xs sm:text-sm md:text-base text-gray-700 mb-2">
                          For instance, SolarSquare's Intelligent WindPro Mount™
                          2.0 mounting structure, which is IIT-Bombay approved,
                          can:
                        </p>
                    ...
                    {component.accessories && (
                      <div className="mt-3 md:mt-4 space-y-3 md:space-y-4">
                        ...
                        {component.accessories.map((acc, idx) => (
                          <div
                            key={idx}
                            className="pl-3 md:pl-4 border-l-2 border-gray-200"
                          >
                            <p className="text-xs sm:text-sm md:text-base font-semibold text-gray-800">
                              {acc.name}:
                            </p>
                        ...
                        <p className="text-xs sm:text-sm text-gray-600 italic mt-3 md:mt-4">
                          Please note: all the DC cable connections are made
        ...
        <section className="mb-6 sm:mb-8 md:mb-16">
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl shadow-md p-4 sm:p-6 md:p-8 border-l-4 border-green-600">
            ...
            <p className="text-xs sm:text-sm md:text-base text-gray-700 mb-3 md:mb-4">
              The net meter helps the discom track the power generated by the
              solar system, the power consumed, the power supplied to the grid,
              and the power imported.
            </p>
            <p className="text-xs sm:text-sm md:text-base text-gray-700 mb-3 md:mb-4">
              At the end of every month, when the electricity bill is generated,
              the readings from the bidirectional meter give an account of:
            </p>
              ...
              <div className="bg-white rounded-lg p-3 md:p-4">
                <p className="text-xs sm:text-sm md:text-base text-gray-700">
                  <span className="font-semibold text-green-700">
                    If you supply more units to the grid than you consumed:
                  </span>{" "}
                  Those units will be deducted from your bill. It will reduce
                  the bill further.
                </p>
              </div>
              <div className="bg-white rounded-lg p-3 md:p-4">
                <p className="text-xs sm:text-sm md:text-base text-gray-700">
                  <span className="font-semibold text-blue-700">
                    If you use extra units from the grid:
                  </span>{" "}
                  Those units would be added to your bill in addition to what
                  your solar plant generated.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-4 sm:mb-6 md:mb-8">
            Now you've seen how multiple on-grid solar system components come
            together, it makes sense to break down the process of sunlight
            getting converted into electricity.
          </p>
        ...
        <section className="bg-white rounded-lg shadow-lg p-4 mb-6 sm:p-8 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6">
            ...
            solar system for home. This subsidy remains the same for all states
            in India.
          </p>
              ...
              <table className="min-w-full border-collapse">
                ...
                <tbody className="text-xs sm:text-sm md:text-base">
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="border p-2 sm:p-3 font-semibold text-green-600">
                      Rs. 30,000
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <section className="bg-white rounded-lg shadow-lg p-4 md:p-8 mb-4 md:mb-8">
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4 md:p-6 rounded-lg">
                <div className="flex items-start space-x-3 md:space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-red-900 text-lg md:text-xl mb-2 md:mb-3">
                      Power Outages
                    </h3>
                    <p className="text-gray-700 mb-3 md:mb-4 text-sm md:text-base leading-relaxed">
                      Although connection with the grid is a sure benefit, it's
                      also a limitation. When there's a power cut from the grid,
                      the on-grid solar system automatically shuts down. This
                      interruption in the supply of power is known as a power
                      outage.
                    </p>
                    <div className="bg-white p-3 md:p-4 rounded-lg">
                      <p className="font-semibold text-gray-900 mb-2 text-sm md:text-base">
                        Anti-Islanding Protection
                      </p>
                      <p className="text-gray-700 text-xs md:text-sm leading-relaxed">
                        The main reason an on-grid solar inverter is designed to
                        automatically shut down if the grid fails is to
                        eliminate safety risks. This feature protects electrical
                        maintenance personnel from electric shocks while working
                        on the grid.
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-4 md:mt-6 bg-blue-50 border-l-4 border-blue-600 p-4 md:p-6 rounded-lg">
                <h3 className="font-bold text-blue-900 text-lg md:text-xl mb-2 md:mb-3">
                  So, which is better: off-grid or on-grid?
                </h3>
                <p className="text-gray-700 mb-2 md:mb-3 text-sm md:text-base leading-relaxed">
                  Hands down, on-grid solar systems in urban areas with a
                  reliable grid are unbeatable for meeting a home's power
                  requirements.
                </p>
                <ul className="list-disc list-inside space-y-1.5 md:space-y-2 text-gray-700 text-sm md:text-base ml-2">
                  ...
                  <li>
                    Government offers subsidy on on-grid systems, not off-grid
                  </li>
                </ul>
                <p className="text-gray-800 font-semibold mt-3 md:mt-4 text-sm md:text-base">
                  ✅ If your power grid is reliable, investing in an on-grid
                  solar system is the smarter choice!
                </p>
              </div>
            </section>
            ...
            <section className="bg-white rounded-lg shadow-lg p-4 md:p-8 mb-4 md:mb-8">
              ...
              <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-4 md:p-6 mb-4 md:mb-6">
                <p className="font-bold text-yellow-900 mb-2 text-sm md:text-base">
                  ⚠️ Important Note:
                </p>
                <p className="text-gray-700 text-xs md:text-sm leading-relaxed">
                  Installing rooftop solar is NOT a DIY task. You must leave it
                  in the hands of experts because it's critical to identify
                  rooftop capacity, determine shadow-free areas, set optimal
                  tilt angles, and carry out safe installation.
                </p>
              </div>
                ...
                {installationSteps.map((step) => (
                  ...
                  >
                    ...
                    <div className="flex-1 pt-0.5">
                      <h3 className="font-bold text-gray-900 text-base md:text-lg mb-1 md:mb-2">
                        {step.title}
                      </h3>
                      <p className="text-gray-700 text-xs md:text-sm leading-relaxed">
                        {step.desc}
            ...
            <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white rounded-lg shadow-lg p-4 md:p-8 mb-4 md:mb-8">
              ...
              <p className="text-base md:text-xl mb-4 md:mb-6 italic opacity-90">
                Making your journey from expensive electricity to free solar
                power easy!
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-5">
                  <h3 className="font-bold text-yellow-400 mb-2 text-base md:text-lg">
                    💰 Zero-Investment Solar Scheme
                  </h3>
                  <p className="text-xs md:text-sm leading-relaxed">
                    Easy loans and financing options where government subsidy
                    offsets initial down payment. EMI schedules from 3 to 120
                    months available.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-5">
                  ...
                  <p className="text-xs md:text-sm leading-relaxed">
                    No middlemen involved. Complete system setup executed by our
                    team in 8 hours.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-5">
                  ...
                  <p className="text-xs md:text-sm leading-relaxed">
                    Minimum 45 maintenance visits over 5 years for deep cleaning
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-5">
                  ...
                  <p className="text-xs md:text-sm leading-relaxed">
                    HILTI AirTight chemical anchoring protects your roof. Rs. 1
                    lakh guarantee for 1 year.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-5 md:col-span-2">
                  ...
                  <p className="text-xs md:text-sm leading-relaxed">
                    First and only solar company in India to offer money-back
                    guarantee at Rs. 8 per unit if we fall short on promised
                    generation.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2 md:space-y-4">
                {faqs.map((faq, index) => (
                  ...
                  >
                    ...
                    >
                      <span className="font-semibold text-left text-gray-900 text-sm md:text-base pr-3">
                        {faq.question}
                      </span>
                      {openFAQ === index ? (
            ...
            <section className="bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-lg shadow-lg p-4 md:p-8 mb-4 md:mb-8">
              ...
              <p className="mb-3 md:mb-4 leading-relaxed text-sm md:text-base">
                Installing an on-grid solar system is a big decision, and it's
                your right to be critical about it. When you choose the right
                quality components, a system you install today can last for at
                least 25 years.
              </p>
              <p className="mb-3 md:mb-4 leading-relaxed text-sm md:text-base">
                The solar panel installation cost in India varies from city to
                city, and you should trust a company that's highly rated by
                customers.
              </p>
              <p className="font-semibold text-base md:text-lg">
                ☀️ The Indian government subsidy is available only till they
                meet the target of solarizing 1 crore homes under PM Surya Ghar
                Muft Bijli Yojana. Go solar now and get freedom from paying for
                electricity!
              </p>
            </section>
          </div>
